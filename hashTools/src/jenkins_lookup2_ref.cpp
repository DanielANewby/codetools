/*****************************************************************************\
Bob Jenkin's lookup2 reference implementation.
...
If you are hashing n strings (const unsigned char **)k, do it like this:
...
EXPORT uint32_t jenkins_lookup2_32(
	const uint8_t *k,         /* the key */
